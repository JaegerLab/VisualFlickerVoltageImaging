function [lineOut, fillOut] = CIshade_flicker(amatrix,alpha,acolor,F,smth, lineStyle, varargin)
...
% adapted from stdshade function: https://www.mathworks.com/matlabcentral/fileexchange/29534-stdshade
% plot CI interval instead of std
...
arraySize = size(amatrix); % assume the first dimension represents sample size
...
hold on;
lineOut = plot(F,amean,'linewidth',0.5, 'LineStyle', lineStyle, 'Color', acolor); %% change color or linewidth to adjust mean line
